...
The information page provides users with information about the shows main characters. I've included basic show information, a few bits of information on each main character and I've also included some audio clips.

**Testing**

| Feature       | Expectation                   | Test Performed     | Outcome      |
| ------------- | ----------------------------- | ------------------ | ------------ |
| Clicked Audio | The selected audio would play | Clicked Audio Icon | Audio Played/Paused/Changed Track when clicking specific/multiple different audio icons |
...
Now we're at the meat and potatoes of the site! It is a memory game - the goal is to pair up characters. I laid it out based on 12 selections all together. When the user 

**Testing**

| Feature       | Expectation                   | Test Performed     | Outcome      |
| ------------- | ----------------------------- | ------------------ | ------------ |
| Playing the game | Select cards, pair them up | Clicked Cards | Cards turned, showed correct images |
| Win Condition | A pop-up alert will fire when game is finished | Finished the game | Alert popped |#
| Reset Button works | Game restarts | Started game then clicked reset | Game reset |

**Game Play**

![game-working](docs/testing/game-working.gif)

 - As mentioned in my [README](README.md) I had an issue where a user could brute force the game and turn over more than 2 cards at a time. This shows the game working as intended. 

**Winner Winner Chicken Dinner**

![win-popup](docs/testing/win-popup.gif)

**Game Reset**

![reset-working](docs/testing/reset-working.gif)#

### 404 Page

A bit of a defensive measure incase a user tries to goto a section of the site that doesn't exist. User will be greeted with a customer 404 page to redirect them.

**Testing**

| Feature            | Expectation                                      | Test Performed                          | Outcome                                                              |
| ------------------ | ------------------------------------------------ | --------------------------------------- | -------------------------------------------------------------------- |
| Custom 404 to redirect | 404 page will appear when navigating to a section that doesn't exist and allow user to go back home | Went to a section that doesn't exist | 404 appeared and redirected |

**404 Working**

![404-working](docs/testing/404-working.gif)
